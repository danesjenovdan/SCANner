...
// Load index.html
const indexFile = fs.readFileSync(`${__dirname}/../besedogled/dist/index.html`, 'utf8', ( err, file ) => err ? reject(err) : resolve(file));
const indexHtml = indexFile.toString();

app.get('/analiza/:analysisId', async ( req, res ) => {
